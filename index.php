...
$domandeFrequenti = [
  ...
  [
    "domanda" => "<p>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</p>",
...
<body>
  ...
  <body>
    <section>
      <div class="container">
          <?php
          foreach ($domandeFrequenti as $domanda) {
            echo"<div class='domande'>" . "<div class='domanda'>" . "<h2>" . $domanda['domanda']. "</h2>" . "</div>" . "<div class='risposta'>"  . $domanda['risposta'] . "</div>" . "</div>" ;
          }
